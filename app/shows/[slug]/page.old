    ...
    <main className="min-h-screen bg-stone-950 px-6 py-12 text-stone-100">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 flex justify-center">
          <Link
            href="/"
           className="inline-flex items-center rounded-lg border border-stone-700 bg-stone-900 px-6 py-3 text-sm font-black uppercase tracking-wide text-stone-200 transition hover:border-stone-500 hover:bg-stone-800"
          >
            ← Return to Homepage
          </Link>
        </div>
